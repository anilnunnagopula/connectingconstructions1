...
import { Send, User, MessageSquare, Check, CheckCheck, Users, ShoppingBag } from "lucide-react";
...
const SupplierMessages = () => {
  ...
  // Handle customer selected from navigation
  useEffect(() => {
    if (location.state?.selectedCustomer) {
      setSelectedUser(location.state.selectedCustomer);
  ...
  const handleUserSelect = async (convUser) => {
    ...
    try {
      await apiClient.put(`/api/chat/read/${convUser._id}`);
      fetchConversations();
    } catch (error) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh)] bg-[#f0f2f5] dark:bg-[#111b21] overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar">
            {loading ? (
              ...
              <div className="p-8 text-center text-[#54656f] flex flex-col items-center">
                <p>No messages yet.</p>
                <p className="text-sm mt-2">Customers will message you when they need help.</p>
              </div>
            ) : (
            ...
            <>
              ...
              <div className="h-[60px] px-4 bg-[#f0f2f5] dark:bg-[#202c33] border-b border-[#e9edef] dark:border-[#2a3942] flex items-center gap-4 flex-shrink-0 z-10 w-full">
                ...
                <div className="flex-1 cursor-pointer">
                  ...
                  <div className="flex items-center gap-1 text-[13px] text-[#54656f] dark:text-[#aebac1] mt-0.5">
                    <span>Customer</span>
                  </div>
                </div>
                <div className="flex gap-4 text-[#54656f] dark:text-[#aebac1]">
