...
const productSchema = new mongoose.Schema(
  {
    ...
    supplier: {
      type: mongoose.Schema.Types.ObjectId, // Use ObjectId to link to the User model
      required: true,
    ...
    name: {
      ...
      required: true,
      trim: true,
      // Consider unique: true with supplier to allow different suppliers to have same product name
    ...
    imageUrls: {
      ...
      type: [String],
      required: false, // Set to true if at least one image is mandatory
      default: [],
    },
