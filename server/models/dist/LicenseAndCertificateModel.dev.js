...
var licenseAndCertificateSchema = new mongoose.Schema({
  supplier: {
    type: mongoose.Schema.ObjectId,
    ref: "User",
    // Assuming your User model
    required: true
  },
  name: {
...
module.exports = mongoose.model("LicenseAndCertificate", licenseAndCertificateSchema);