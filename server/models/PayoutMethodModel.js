...
const PayoutMethodSchema = new mongoose.Schema({
  ...
  details: {
    // For BANK_TRANSFER
    accountNumber: { type: String, trim: true }, // Encrypt this in real app
    ifscCode: { type: String, trim: true }, // Encrypt this in real app
    bankName: { type: String, trim: true },
    accountHolderName: { type: String, trim: true },
    // For UPI
    upiId: { type: String, trim: true }, // Encrypt this in real app
  },
  isDefault: {
